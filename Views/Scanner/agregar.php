...
<div class="container justify-content-md-center">
    <div align="center">
        <div class="card" style="width: 12%;">
            <img src="<?php echo URL?>Public/imagenes/hand.png" class="card-img-top">
        </div>
    </div>
    <div class="text-center">
        <h2>Agrega un Scanner </h2>
    </div>
    <div class="row justify-content-md-center">
        <div class="col-md-5 order-md-1">
            <form class="was-validated"  method="POST" action="<?php echo URL?>Scanner/agregar" enctype="multipart/form-data" autocomplete="off">
